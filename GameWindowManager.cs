...
{
	public static DiabloWindow Window = new();
	...
	internal static bool Update()
	{
		...
		Window.IsForeground = GetForegroundWindow() == Window.Handle;
		return true;
	}
	...
	public static unsafe void ReadPointerArray(long address, long[] buffer, int offset, int count)
	{
		fixed (long* ptr = &buffer[offset]) {
			ReadProcessMemory(ProcessHandle, checked((IntPtr)address), ptr, count * sizeof(long), out _);
		}
	}
