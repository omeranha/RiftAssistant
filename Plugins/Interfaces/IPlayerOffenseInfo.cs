...
public interface IPlayerOffenseInfo
{
	...
	List<(ISnoPower, float)> PlainDamageBonuses { get; }
	...
	float WeaponBaseDamageMinAoffHand { get; set; }
	...
	float WeaponBaseDamageMinBoffHand { get; set; }
	...
	float[] ElementalDamageBonus { get; set; }
